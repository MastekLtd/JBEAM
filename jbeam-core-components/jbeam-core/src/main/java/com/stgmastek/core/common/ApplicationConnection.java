...
/**
 * This class is a wrapper around the connection to application schema.
 * 
 * @author grahesh.shanbhag
 * 
 * @see BatchConnection
 */
public final class ApplicationConnection extends CConnection {
	 ...
	 */
	public ApplicationConnection(Connection connection){
		super(connection);
	}
	 ...
	 * are closed. Also connection from the PRE framework is not used and new connection pools 
	 * are created as needed. In this case there are three pools, one for PRE, one for the BATCH, 
...
* Revision Log
* -------------------------------
* $Log:: /Product_Base/Projects/Batch/Code/Java/Core/src/com/stgmastek/core/common/ApplicationConnection.java                                                                        $
 * 
