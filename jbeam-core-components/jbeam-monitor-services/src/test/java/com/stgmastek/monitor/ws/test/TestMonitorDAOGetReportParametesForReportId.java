...
/**
 * JUnit class to test the MonitorDAO method getReportParametesForReportId  
 * 
 *@author Mandar Vaidya
 */
public class TestMonitorDAOGetReportParametesForReportId extends TestCase{
	...
	public void testGetReportParametesForReportId(){
		...
		try{
			...
			List<ReportParameter> reports =  dao.getReportParametesForReportId(report, connection);
			for (ReportParameter report : reports) {
				System.out.print("Report id = " + report.getReportId());
				System.out.print("\tParameter name = " + report.getParamName());
				System.out.println("\tParameter name = " + report.getFieldMaxlength());
			}
