...
set HOME=%HOME:\=/%
echo %HOME%
start "%WTITLE%" %JAVA_HOME%\bin\java.exe -Djbeam-com.stgmastek.monitor.ws.server.dao.monitordaoimpl=com.stgmastek.monitor.ws.server.dao.impl.MonitorDAO -Djbeam-com.stgmastek.monitor.ws.server.dao.userdaoimpl=com.stgmastek.monitor.ws.server.dao.impl.UserDAO -classpath %classpath% com.stgmastek.monitor.ws.main.StartMonitorWS -startup %HOME%/log4j.properties 
