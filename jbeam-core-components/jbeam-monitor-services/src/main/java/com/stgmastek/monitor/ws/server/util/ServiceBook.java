...
/**
 * 
 * Serves as the dictionary for the servers created within the 
 * Monitor WS system   
 * 
...
* Revision Log
* -------------------------------
* $Log:: /Product_Base/Projects/Batch/Code/Java/MonitorServices/src/com/stgmastek/monitor/ws/server/util/ServiceBook.java                                                            $
 * 
