...
/**
 * Super class for all the connection classes within the system.
 * 
 * @author grahesh.shanbhag
 * 
 */
public abstract class CConnection implements Connection {
...
* Revision Log
* -------------------------------
* $Log:: /Product_Base/Projects/Batch/Code/Java/MonitorServices/src/com/stgmastek/monitor/ws/util/CConnection.java                                                                   $
 * 
 * 5     6/23/10 11:28a Lakshmanp
 * added java.sql.connection implementation
 * 
 * 4     12/30/09 1:10p Grahesh
