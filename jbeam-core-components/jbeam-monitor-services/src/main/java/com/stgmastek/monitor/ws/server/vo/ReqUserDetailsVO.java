 ...
 * @since $Revision: 1 $  
 */
public class ReqUserDetailsVO extends BaseRequestVO{
...
* Revision Log
* -------------------------------
* $Log:: /Product_Base/Projects/Batch/Code/Java/MonitorServices/src/com/stgmastek/monitor/ws/server/vo/ReqUserDetailsVO.java                                                         $
 * 
 * 1     6/30/10 3:16p Lakshmanp
 * Initial Version
 * 
