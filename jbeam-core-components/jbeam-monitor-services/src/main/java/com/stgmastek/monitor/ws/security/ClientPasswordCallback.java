...
public class ClientPasswordCallback implements CallbackHandler {
	...
	public void handle(Callback[] callbacks) throws IOException,
		...
		System.out.println("ClientPasswordCallback ... ");
...
* Revision Log
* -------------------------------
* $Log:: /Product_Base/Projects/Batch/Code/Java/MonitorServices/src/com/stgmastek/monitor/ws/security/ClientPasswordCallback.java                                                    $
 * 
