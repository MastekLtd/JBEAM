...
public class WSServerInfo {
	...
	/** The unique server name. Used internally by the monitor communication system */
...
* Revision Log
* -------------------------------
* $Log:: /Product_Base/Projects/Batch/Code/Java/MonitorComm/src/com/stgmastek/monitor/comm/server/util/WSServerInfo.java                                                             $
 * 
