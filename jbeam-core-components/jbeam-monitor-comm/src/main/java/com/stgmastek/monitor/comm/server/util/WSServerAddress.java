...
public class WSServerAddress {
	 ...
	 * @see CommConstants for default host and port 
	 * 
	 * @param domain
...
* Revision Log
* -------------------------------
* $Log:: /Product_Base/Projects/Batch/Code/Java/MonitorComm/src/com/stgmastek/monitor/comm/server/util/WSServerAddress.java                                                          $
 * 
