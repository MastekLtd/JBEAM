 ...
 *
 */
public class TestBatchDAOSetDeadMessage extends TestCase{
	...
	public void testGetInstructionLog(){		
		...
		try{
			...
			message.setId(1);
			message.setInstallationCode("GRAHESH");
			message.setMessage("BSRUNBATCH");
			message.setMode("I");
			message.setParam("seqNo=65");
			Boolean flag = dao.setDeadMessage(message, new Throwable("some thing is wrong"),connection);
			assertTrue(flag);
		}catch(Exception e){
...
* Revision Log
* -------------------------------
* $Log:: /Product_Base/Projects/Batch/Code/Java/MonitorComm/src/com/stgmastek/monitor/comm/test/TestBatchDAOSetDeadMessage.java                                                      $
 * 
