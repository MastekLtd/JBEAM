...
/**
 * 
 * Serves as the dictionary for the servers created within the core communication system   
 * 
...
public final class ServiceBook {
	...
	/** Private map to hold the information of all the servers created */
...
* Revision Log
* -------------------------------
* $Log:: /Product_Base/Projects/Batch/Code/Java/CoreComm/src/com/stgmastek/core/comm/server/util/ServiceBook.java                                                                    $
 * 
 * 4     12/30/09 12:15p Mandar.vaidya
 * Removed warnings
 * 
 * 3     12/18/09 3:05p Grahesh
