 ...
 * change the queries to make the database agnostic, this marker could be used to 
 * locate the queries 
 *  
...
* Revision Log
* -------------------------------
* $Log:: /Product_Base/Projects/Batch/Code/Java/CoreComm/src/com/stgmastek/core/comm/util/DatabaseAgnosticCandidate.java                                                             $
 * 
