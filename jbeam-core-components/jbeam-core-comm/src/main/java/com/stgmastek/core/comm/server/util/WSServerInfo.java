...
public class WSServerInfo {
	...
	/** The unique server name. Used internally by the core communication system */
	 ...
	 * 		  The server name
	 * @param address
	 * 		  The address related information. @see WSServerAddress
	 */
	 ...
	 * 
	 * @param address
	 * 		  The address to set @see WSServerAddress 
	 */
...
* Revision Log
* -------------------------------
* $Log:: /Product_Base/Projects/Batch/Code/Java/CoreComm/src/com/stgmastek/core/comm/server/util/WSServerInfo.java                                                                   $
 * 
