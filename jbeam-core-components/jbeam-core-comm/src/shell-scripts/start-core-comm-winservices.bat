...
set HOME=%HOME:\=/%
echo %HOME%
%JAVA_HOME%\bin\java.exe -Djbeam-com.stgmastek.core.comm.server.dao.statusdaoimpl=com.stgmastek.core.comm.server.dao.impl.StatusDAO -Djbeam-com.stgmastek.core.comm.server.dao.batchdaoimpl=com.stgmastek.core.comm.server.dao.impl.BatchDAO  -classpath %classpath% com.stgmastek.core.comm.main.StartCoreCommunication -startup %HOME%/log4j.properties 
