...
<xsl:param name="bundled-on" select="'{$bundled-on}'"/>
...
<xsl:template name="pageHeader">
    <h1>Unit Test Results : <xsl:value-of select="$title"/></h1>
    <table width="100%">
    <tr>
        <td align="left"></td>
    ...
    <tr>
        <td align="left"></td>
        <td align="right"><i>Execution Timestamp : <xsl:value-of select="$bundled-on"/></i></td>
    </tr>
    <tr>
        <td align="left"></td>
        <td align="right"><i><xsl:text disable-output-escaping="yes">Copyright &amp;copy;</xsl:text> <xsl:value-of select="$copyright"/></i></td>
    </tr>
    </table>
    <hr size="1"/>
</xsl:template>
