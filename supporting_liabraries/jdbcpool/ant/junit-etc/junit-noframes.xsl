...
<xsl:template match="testsuites">
    <html>
        <head>
            <title>Unit Test Results : JDBCPool</title>
    <style type="text/css">
      body {
...
<xsl:template name="pageHeader">
    <h1>Unit Test Results : JDBCPool</h1>
    <table width="100%">
    <tr>
        <td align="left"></td>
    ...
    <tr>
        <td align="left"></td>
        <td align="right"><i>Copyright 2002 Systems Task Group International Limited. All Rights Reserved.</i></td>
    </tr>
    </table>
    <hr size="1"/>
</xsl:template>
