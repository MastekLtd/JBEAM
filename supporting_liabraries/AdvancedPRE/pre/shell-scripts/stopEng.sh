...
java -Dpre.home=$SCHEDULER_HOME -Duserid=$USERID -Djobid="1.000" -Dreqtype="GENERAL" -Djava.compiler=NONE -classpath $CLASSPATH admin.CStopEngine $SCHEDULER_HOME/resources/prinit.properties 
