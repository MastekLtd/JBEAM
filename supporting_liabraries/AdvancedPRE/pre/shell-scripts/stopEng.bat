...
echo %SCHEDULER_HOME%
start "%WTITLE%" "%JAVA_HOME%\bin\java.exe" -Duserid=%USERID% -Djobid="1.000" -Dreqtype="GENERAL" -classpath %CLASSPATH% admin.CStopEngine %SCHEDULER_HOME%/resources/prinit.properties 
