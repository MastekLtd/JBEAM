 ...
 * $Revision: 2382 $
 *
 * $Header: http://192.100.194.241:8080/svn/ProductTools/JavaTools/AdvancedPRE/trunk/src/stg/database/CBeanException.java 1402 2010-05-06 11:14:41Z kedar $
 *
 * $Log: /Utilities/PRE/src/stg/database/CBeanException.java $
 * 
 * 5     3/22/08 3:45p Kedarr
 * Added the REVISION variables to store the configuration management
 * version number of the class.
 * 
 * 4     3/01/07 4:45p Kedarr
...
/**
* All the Beans will throw CDBException.
**/
public class CBeanException extends CDBException
{
     ...
     */
    private static final long serialVersionUID = 934305015266837151L;
    ...
    **/
    public CBeanException()
    {
        super();
    }
    
    /**
    *   Constructs an Object of CBeanException
    *   @param pstr Error Message
    **/
    public CBeanException(String pstr)
    {
        super(pstr);
    }
