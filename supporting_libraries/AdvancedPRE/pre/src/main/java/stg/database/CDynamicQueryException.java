 ...
 * $Revision: 2382 $
 *
 * $Header: http://192.100.194.241:8080/svn/ProductTools/JavaTools/AdvancedPRE/trunk/src/stg/database/CDynamicQueryException.java 1402 2010-05-06 11:14:41Z kedar $
 *
 * $Log: /Utilities/PRE/src/stg/database/CDynamicQueryException.java $
 * 
...
/**
*   Thrown when an exception occurs in the CDynamicQueryBuilder
**/
public class CDynamicQueryException extends CDBException
{
	 ...
	 * Serial Version.
	 */
	private static final long serialVersionUID = 2308204283394629287L;

	/**
    *   Constructs an Object CDynamicQueryException
    **/
    public CDynamicQueryException()
    {
        super();
    }
    ...
    **/
    public CDynamicQueryException(String pstr)
    {
        super(pstr);
    }
...
} //end of CDynamicQueryException.java
