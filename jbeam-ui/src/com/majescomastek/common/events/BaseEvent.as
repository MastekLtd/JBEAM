 ...
 * $Revision::                                                                                                     $
 *	
 * $Header:: /Product_Base/Projects/EBPPSBS/EBPP Pure MVC/EBPP_PUREMVC_UI/src/com/majescomastek/ebpp/events/BaseEven $	
 *
 * $Log:: /Product_Base/Projects/EBPPSBS/EBPP Pure MVC/EBPP_PUREMVC_UI/src/com/majescomastek/ebpp/events/BaseEven $
 * 
 * 
 * 
 */
package com.majescomastek.common.events
{
	...
	/**
	 * A base event class which carries data along with the event name.
	 */
	public class BaseEvent extends Event
	{
		...
		public function BaseEvent(type:String, eventData:Object, bubbles:Boolean=false, cancelable:Boolean=false, originEvent:Event=null)
		{
	    ...
	    {
	        return new BaseEvent(this.type,this.eventData, this.bubbles, this.cancelable,this.originEvent);
	    }
