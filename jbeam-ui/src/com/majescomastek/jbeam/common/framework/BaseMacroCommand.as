...
package com.majescomastek.jbeam.common.framework
{
	...
	/**
	 * The base class which extends on the capabilities of the PureMVC MacroCommand.
	 * (a special type of Command which executes other commands)
	 * <p>
	...
	public class BaseMacroCommand extends MacroCommand
	{
		...
		/**
		 * Create a <code>BaseMacroCommand</code> object with an empty command list.
		 */
