...
{
	/**
	 * The class used for holding per scan Execution count graph data. 
	 */
	[Bindable]
	public class PerScanExecutionCountGraphData extends BaseValueObject
	{
		public function PerScanExecutionCountGraphData()
		{
			super();
		}
