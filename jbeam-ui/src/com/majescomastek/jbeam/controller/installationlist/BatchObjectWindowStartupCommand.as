...
package com.majescomastek.jbeam.controller.installationlist
{
	 ...
	 */
	public class BatchObjectWindowStartupCommand extends BaseSimpleCommand
	{
		override public function execute(notification:INotification):void
		{
			var data:Object = notification.getBody();
			var failedObjectsWindow:BatchObjectWindow = BatchObjectWindow(data['view']);
			var mediator:BatchObjectWindowMediator = new BatchObjectWindowMediator(failedObjectsWindow); 
			facade.registerMediator(mediator);
			sendNotification(InstallationListModuleFacade.BATCH_OBJECTS_WINDOW_STARTUP_COMPLETE,
