...
package com.majescomastek.jbeam.controller.batchdetails
{
	...
	/**
	 * The command class used to refresh the object execution graph pod data.
	 * 
	 ...
	 * of the screen. 
	 */
	public class ObjectExecutionGraphPodRefreshCommand extends BaseSimpleCommand
	{
		override public function execute(notification:INotification):void
		{
			...
			proxy.getObjectExecutionGraphData(batchDetails, mediatorName);
		}
	}
}